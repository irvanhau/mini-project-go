...
// AppointmentDataInterface is an autogenerated mock type for the AppointmentDataInterface type
type AppointmentDataInterface struct {
	mock.Mock
}

// Delete provides a mock function with given fields: id
func (_m *AppointmentDataInterface) Delete(id int) (bool, error) {
	ret := _m.Called(id)
...
func (_m *AppointmentDataInterface) GetAll(page int) ([]appointments.AppointmentInfo, int, int, error) {
	ret := _m.Called(page)
...
func (_m *AppointmentDataInterface) GetByID(id int) ([]appointments.AppointmentInfo, error) {
	ret := _m.Called(id)
...
func (_m *AppointmentDataInterface) Insert(newData appointments.Appointment) (*appointments.Appointment, error) {
...
func (_m *AppointmentDataInterface) Update(newData appointments.UpdateAppointment, id int) (bool, error) {
...
// NewAppointmentDataInterface creates a new instance of AppointmentDataInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewAppointmentDataInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *AppointmentDataInterface {
	mock := &AppointmentDataInterface{}
	mock.Mock.Test(t)
